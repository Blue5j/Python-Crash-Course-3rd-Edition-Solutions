# 2-9. Dinner Guests: Working with one of the programs from Exercise 3-4 through 3-7, use `len()` to print a message indicating the number of people you are inviting to dinner.
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
